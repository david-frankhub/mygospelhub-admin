            ...
            {content.map(c => (
              <div key={c.id} className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
                ...
                <div className="flex gap-2">
                  <button onClick={() => toggleStatus(c.id, c.status)} className="flex-1 flex items-center justify-center gap-1.5 py-2 text-xs font-medium text-zinc-300 bg-zinc-800/60 hover:bg-amber-500/10 hover:text-amber-400 rounded-lg transition-colors">
                    <Edit3 size={13} /> {c.status === "Published" ? "Unpublish" : "Publish"}
                  </button>
